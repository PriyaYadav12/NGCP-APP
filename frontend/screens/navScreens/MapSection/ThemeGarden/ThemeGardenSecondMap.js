...
export default function ThemeGardenSecondMap({ navigation }) {
                ...
                >
                    ...
                    <View style={styles.container}>
                        ...
                        <View style={styles.heading}>
                            ...
                            <View style={{ ...styles.titleBox, backgroundColor: colors.secondary.colorShade1 }}>
                        ...
                        <View style={styles.zoneHeading}>
                            ...
                            <View style={{ ...styles.ZoneBox, backgroundColor: colors.secondary.colorShade1 }}>
                                <View style={styles.letter}>
                                    <Text style={styles.text}>{`B${currentPointIndex + 1}`}</Text>
                                </View>

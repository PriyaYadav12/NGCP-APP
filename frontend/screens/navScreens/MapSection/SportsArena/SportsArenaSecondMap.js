...
export default function SportsArenaSecondMap({ navigation }) {
                ...
                >
                    ...
                    <View style={styles.container}>
                        ...
                        <View style={styles.heading}>
                            ...
                            <View style={{ ...styles.titleBox, backgroundColor: colors.tertiary.colorShade1 }}>
                                <Text style={styles.title}>SPORTS ARENA</Text>
                            </View>
                        ...
                        <View style={styles.zoneHeading}>
                            ...
                            <View style={{ ...styles.ZoneBox, backgroundColor: colors.tertiary.colorShade1 }}>
                                <View style={styles.letter}>
                                    <Text style={styles.text}>{`C${currentPointIndex + 1}`}</Text>
                                </View>
